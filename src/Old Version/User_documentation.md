Sirius SCADA user documentation 26
...
Toopenthewebportal,opentheGoogleChromeapplicationonyourPCandentertheaddress(URL)youhavebeen givenintheaddressfieldofthebrowser.Fortheplantsystems,theaddresswillbeoftheform:
...
Eachreportnormallyhasafilteringpart,wheretheusercanspecifywhatkindofdatatoretrieve,timeperiod,etc. Afterspecifyingthedatafiltering,thereportisgeneratedanpresentedonthescreen.
...
Thepop-upwindowopensinnewwindowsandmustbeclosedpressingtheupperrightcrossonthewindow.
...
Alarmscanbeacknowledgedusingthe"Acknowledge"buttonbelowthelist.Alarmstobeacknowledgedareselected usingthecheckboxestotheleftinthelistandthenpressingthebutton.Anoptionalcommentcanbeaddedbefore pressingbutton.Thiscommentisstoredinthedatabase,andcanbeseeninthehistoricalalarmreport.
...
Whenretrievingaggregateddata,aggregatedvaluesarecalculatedforthetimeintervals.E.g.whensinginterpolative,thedatais interpolatedforthetimeintervalswitheither0.or1.orderinterpolation.
...
Theequipment/plantstatecanbecorrectedinauserscreenintheplantportal.See**Equipment downtime general (Section 4.4.1)** .
...
Stateloggingissetupforallinverters.EachinverterwithintheSKiDisconsideredaprocessunit.Namingissetto: <Country>-<Site>-TSXY.I0Z:
...
InverterusedatLosPradossite. Receivedoperatingstateisderivedfromstatetagsforeachinverterbridge:
...
|12100|Error,nopowerproduction|Not Scheduled|State = 0 && external|Red|
...
Elseif(WeatherCalc.AboveInverterStartupLevel)
...
§ XX:stationnamefrom01tonumberofstations
...
**Equipment downtime (state) (Section 4.3.1)**canbecorrectedinamanualuserscreenintheplantwebportal.
...
Ifyouregisteranoutageoutsidethetimeintervalofyourtimefilter,itwillnotshowintable.Thenchangeperiod filtertoseethenewoutage.
...
Existingcodescanbeeditedfromthelist.Press"Addnew"buttontoaddnewcode. Ingeneral,codeeditingshouldbehandledwithcare,andseeninrelationtocalculationsandformulas.
...
Generalrolesusedintheplantsolutionsare:
...
TheplantreportscontainsreportsdirectlyfromtheplantdatabasesACTdatabaseandAPISHoneystoretimeseries database.
...
3. Failure rate and repair time calculation
...
1.and2.Performanceratiocontractual(LDandbonus): Basicformulaasbelow,butmightbeoverriddenbyplantspecificformulas. Parametersvaryfromplanttoplant.

- PRContractualBonus=(EAdj\*Is)/(Pnom\*Xd\*Iacc\*Kd\*A)
  - EAdj:Measuredenergyproduction,manuallyadjustedifnecessary
    - Is:Irradianceatstandardtestconditions,1000W/m2
  - Xd:moduledegradationfactor.Calcualtedbasedoninitialandyearlymoduledegradation. Moduledegradationcalculatedbasedonfirstandlastmoduleinstallationdate(averageage).
    - Pnom:nominalDCpowerofplant
      - Kd:plantdowntimefactor.GridoutageoutsideScateccontrol.
    - IAcc:accumulatedirradiation
      - A:ImpliedwarrantedPlantavailabilityasperO&M/EPCcontract

3.Performancerationet Thisformulaonlylooksonenergyproducedinrelationtothemeasuredaccumulatedirradiation.

- PRnet=EAdj\*Is/Pnom/Iacc
  - EAdj:Measuredenergyproduction,manuallyadjustedifnecessary
    - Is:Irradiationatstandardtestconditions,1000W/m2
  - Pnom:nominalDCpowerofplant
    - Iacc:accumulatedirradiation

4.Performanceratiogross ThisformulaadjustthePerformancerationetbyplantandgridavailability

- PRGross=PRNet/PAd/GAdg
  - PRNet:performancerationet
    - PAd:Plantavailabilitydaylight,see**plant availability (Section 4.7.7.1)**
  - GAdg:Gridavailabilitydaylightgross,see**grid availability (Section 4.7.7.2)**

5.Performanceratiogrossproductionloss UsesPRnetasbasis,butproductionisusingmeasuredproduction+productionlossesduetodowntime.

- PRGrossProdLost=EAdjGross\*Is/Pnom/Iacc
  - EAdjGross:Measuredenergyproduction,manuallyadjustedifnecessary+productionlostdue toinvertersandgriddowntime
    - EAdjGross=EAdj+ProductionLostInverters+ProductionLostGrid
      - Is:Irradianceatstandardtestconditions,1000W/m2
    - Pnom:nominalDCpowerofplant
- Iacc:accumulatedirradiationinthemoduleplane.
  - Ifnoirradiationexistsforperiod,usefollowingalgorithm:
1. TrytousehorizontalirradiationmeasurementwithTranspositionFactor(TF) fromexternalweathersource(SolarGIS)
1. Trytouseinclineirradiationdatafromexternalweathersource(SolarGIS)
1. Useirradiationforsametimepreviousdays.30daysbackischecked.Average forfirst5dayswithmeasurmentsisused.
5. Deemed energy calculation

Deemedenergycalculationsmighthavedifferentformatsoneachplant. Seedescriptionforeachplant.

6. Production losses

Productionlossesarecalculatedbasedondowntimeregistrations. **Inverter losses**

FollowingalgorithmisimplementedinSCADAtoestimateproductionlostoninverters(aslongasthetotalinverter capacitydownisbelow[80%]):

- ProductionLostInverters=EAdj\*TotalNomPowerDown/(Pnom–TotalNomPowerDown)
  - EAdj:measuredenergyproductionoftheplantduringtheperiod,adjustedinnecessary
    - NomPowerDown:nominalDCpowerofthesingleinverterexperiencingdowntime
  - Pnom:totalnominalDCpowerofplant
    - TotalNomPowerDown:totalnominalDCpowerofallinvertersexperiencingdowntime.Sumof allNomPowerDown.

FollowingalgorithmisimplementedinSCADAtoestimateproductionlostoninverters(whenthetotalinverter capacitydownisabove[80%]):

- ProductionLostInverters=PR\_reference\*TotalNomPowerDown\*InclineIrradiation\*/Irr\_STC
  - PR\_reference:CalculateareferencePRGrossProdLostforthereferenceperiodof5(full)days priortothedayinwhichthedowntimeoccurs(includingtheeffectsofanyproductionlost duringthatreferenceperiod)
  - TotalNomPowerDown:TotalnominalDCpowerofallinvertersexperiencingdowntime.Sumof allNomPowerDown.
    - InclineIrradiation:Avaregameasuredinclinepyranometervaluefortheperiod.Ifnoirradiation existsforthe10minuteperiod,SolarGISdataisused.
      - Irr\_STC:Irradianceatstandardtestconditions.Standard1000W/m2

**Grid losses**

Griddowntimeisclassifiedintofollowingclasses:
...
“Failuretime”,“Idletime”and“Linerestrainttime”iscountedasdowntimeresultinginreducedplantavailability andthusproductionlostduetodowntime.

Gridproductionlossiscalculatedastheestimatedproductionbasedonweatherdata,adjustedforplantstatus conditionsbeforegriddowntime.Followingprinciplesareused:

- Estimatedproductioncalculatedbasedonstandardproductionformulausingfoolowingdatainputs:
  - Nominalpowerofplant
    - InclineIrradiationmeasurements(SolarGISdataifnotpresent)
  - Estimatedcelltemperature
    - Moduleefficiency
  - Invertereffiency
    - Loss factors
  - Adjustmentfactoriscalculatedbasedonestimatedproductionandmeasuredproduction1hourbefore griddowntimestarts
    - Adjustmentfactorislimitedtotheinterval0,7-1,3

**Tracker losses**

- Trackerdowntimeloss[MWh]:ActualproductioninMWh\*(1-Trackeravailabilityin%)\*(Transposition Factorin%-1)
  - WhereTranspositionFactor=GlobalInclineIrradiation/GlobalHorizontalIrradiation

**Soiling losses:**

- ActualProduction/(1-Soilingrate)–ActualProduction

**Curtailment losses:**

Forperiodswithcurtailment:

- Estimatedproduction–ActualProduction
7. Energy Performance Index

EnergyPerformanceIndex(EPI)iscalculatedastherelationbetweentheproductionactualvs.budgetandthe irradiationactualvsbudget.

Theactualformulais:

EPI=100\* (100+ (Actual Prod - [Budget Prod](mailto:BudgetProd-@ActualProd\)\)/\(100))/Actual[Prod](mailto:BudgetProd-@ActualProd\)\)/\(100))) / (100+(Actual Irradiation- [Budget I](mailto:BudgetProd-@ActualProd\)\)/\(100)rradiation)/Actual Irradiation)

8. Curtailment losses

Curtailmentlossesarecalculatedbasedonregisteredcurtailmentperiods.

Foreachperiod,estimatedproductioniscalcualtedbasedonmeasuredirradiationandavailablenominalpower. Thedifferencebetweenestimatedandmeasuredvalueisdefinedasthelosses.

8. Forecasting
1. Forecasting principles

Therearethreetypesofforecastsinthesystem:

- PVSYSTsimulationvalues
  - HourlyvaluesfromPVSYSTsimulationsoftware
    - Monthyproductiondivededequallybetweeneachday
  - Loadedonplatsystemandavailableinplantreports
    - AvailableinHoneystoretimeseriesdatabaseandinProcessExporerunder<plant>-Forecast database
      - Availableincentralreportsunder"PVSYSTForecast"forcasttype(**External forecast report (Section 5.6.4.9)**)
  - Scatecbudgetvalues
  - Budgetvaluesloadedintodatawarehouse
    - Dailyvalues
  - Availableincentralreportsasforecasttypes(**Measured vs forecast (Section 5.6.4.18)**)
    - Internaloriginalbudget
      - Internalupdatedbudget
    - Externaloriginalbudget
- SolarGISforecastvalues
  - ForecastloadedfromSolarGISforecastserviceprovider
    - Powerandweatherforecastloadedeachday
  - 15minutevalues
    - Two types:
      - RollingDaily:9daysahead,updatedforalldayseverydayatmidnight.Datafornext daysoverwrittenandupdatedeveryday.
      - WeekAhead:updateddayoneweekahead.Dataisnotoverwrittem
  - Availableincentralreports(**External forecast report (Section 5.6.4.9)**)
2. PVSYST forecast

InitialhourlyforecastonplantsystemisbasedonPVSYSTsimulation.Followingdataisstoredperhour:
...
ThePVSYSTinitialdataareaveragedpermonth,havingsamevaluesforeachtimeofdaythroughoutthemonths (implementedfromJordanplants).Thisremovestheunaturalstatisticalvariations.

3. SolarGIS forecast

FollowingdataisretreivedfromSolarGISforecastingservice:

- Horizontalirradiation
  - Inclineirradiation
- Diffuseirradiaiton
  - Evironmenttemperature
- Power production
  - Energyproduction
- Wind speed
4. Scatec budget data

ScatecbudgetdatacanbeuploadedbyPrediktorfromExcelfileorupdatedmanuallyfromuserscreen(**Budget updates (Section 5.7.3)**).

Followingbudgetsavailable:

- Internaloriginalbudget
  - Internalupdatedbudget
- Externaloriginalbudget

Followingparamatersarestored:

- HorizontalIrradiation(kWh/m2)
  - InclineIrradiation(kWh/m2)
- Ambienttemperature(C°)
- Moduletemperaturedaylight(C°)
  - Netproduction(kWh)
- Modifiedplantavailability(%)
  - Modifiedgridavailability(%)
- Nettariff(LC/MWh)
  - Actualnettariff(LC/MWh)
- SpecialCompensation(LC\*1000)
  - Performanceratiogross(%)

UsercanselectwhenuploadingwhatdatatobeshowninthescatecApp. Normallyitisinternaloriginalbudget.

9. App data access

4.9.1 General app concepts

TheScatecSolarmobileAppisavailabletoviewaggregatedproductionandbudgetdatafromtheplantsonmobile deviceslikesmartphones.

TheappisdevelopedandmaintainedbyMobivention,butdataisfedfromcentralSCADAsystem. Accesstoappdataiscontrolledbyuserandaccesscontrolincentralportalasdescribed**here (Section 5.4.3)**.

10. General plant monitoring
1. Plant overview

Plantoverviewpageshowsmaindataforwholeplant. Clickingoninverternamesopeninverterdetailspage. ExamplebelowfromBrazilApodi:

![](yryhdz2b.053.jpeg)

![](yryhdz2b.054.jpeg)

2. Overall production overview

Showsproductiondataforplant. ExamplefromBrazilApodibelowwithexplanations.

![](yryhdz2b.055.jpeg)

3. String monitor overview

Showsstringmonitordataforplant. Clickingononeofthebarsopendetailsorcombinerbox. ExamplefromBrazilApodibelowwithexplanations.
...
4. Transformer switch overview

Showsswitchstateandsubstationstatusforplant. ExamplefromBrazilApodibelowwithexplanations.

![](yryhdz2b.058.jpeg)

5. Inverter details

Showsdetaileddataforinverter/trao.Differentsetupforthedifferentsuppliers. ExamplefromGEinverterfromBrazilApodibelowwithexplanations.

![](yryhdz2b.059.jpeg)

6. Inverter power overview

Showspowerforallinverters.Chartssplitintoequalnominalpower.

ExamplefromBrazilApodibelowwithexplanations.

![](yryhdz2b.060.jpeg)

7. Inverter insulation overview

Showsinverterinsulationvaluesforallinverters,ifnofloatinggroundoninverters. ExamplefromBrazilApodibelowwithexplanations.

![](yryhdz2b.061.jpeg)

8. Substation

Showssubstationmeteringandstatusvalues. ExamplefromBrazilApodibelowwithexplanations.

![](yryhdz2b.062.jpeg)

9. Weather data

Showsweatherdataforplant. ExamplefromBrazilApodibelowwithexplanations.

![](yryhdz2b.063.jpeg)

10. Tracker data

Showstrackerdataforplantifavailable.Differentsetupforthedifferenttrackertypes. Normally2or3levels:

- Overviewplants
- Overviewstation(notonall)
  - Trackerdetails

ExamplefromBrazilApodibelowwithexplanations.SHowingsoltectrackers. Level1,plant:
...
ShowsPPCdata. ExamplefromBrazilApodibelowwithexplanations.

![](yryhdz2b.067.jpeg)

12. Alarm list

Showscurrentalarmstateforalarmsonplant. ExamplefromBrazilApodibelowwithexplanations.
...
Thecentralreportingsystemconsistofareportingpartandacontrolandmonitoringpart,allcontainedinone centralwebportal.Datafromthedifferentplantsarereplicatedintothecentralserversandusedforrealtimeand historicalreporting.

Realtimeandtimeseriesdataisreplicatedintoonedatabaseforeachplant,includingtheeventbasedplantdata. ThesedataisuseddirectlyintheSCADAportalfordynamicHMIscreensandplantreports.

TheplantdataisextractedfromtheplantdatabasesandstoredinonecommonScatecSolardatawarehouse, containingdataforallplants.Usingthecentralreports,datafromallplantscanbeviewedseparatelyorincommon reports.

2. Data storage

Thecentralreportingservercontainsthe10minuteaveragedatastoreperplant,theforecastdatabaseperplantand thedatawarehouse.ThedatawarehousedatabaseisnamedSSO\_DWH.

The10minutetimeseriesdatabasehasthefollowingnamingconversion: *COUNTRY-SITE-Log10Min*
...
Theforecasttimeseriesdatabasehasthefollowingnamingconversion: *COUNTRY-SITE-Forecast*
...
ThecentralSCADAservercontainsthe1minutedatastoreperplant.Thedatabasehasthefollowingnaming conversion:

*COUNTRY-SITE-Log1Min* E.g.:*SA-LI-Log1Min*

- SA: South Africa
  - KB:Kalkbult
3. Central web portal
1. Portal navigation general

ThewebportalfromthecentralserverisopenedwiththeURLaddress <https://scada.scatecsolar.com/SSO_Central/login3.aspx>

Startingtheportalandlogginginisasdescribedin**Web portal basics. (Section 4.1.1)** Themenuisbuiltupwithonemainfolderforenterprisefunctionsandonefolderforeachplant,locatedunderthe

continentfolderasfollows:
...
Undereachplantfolder,subfoldersarefoundfor:

- Plantmonitoring
  - Reporting
- Analysis

UnderEnterprise,followingmainnodesarefound:
...
PlantmonitoringandplantreportsaremoreorlessthepagesfoundonplantSCADAsolution(ifpresent).Datais collectedfromthecentralserverdatabasesandrealtimestorethough,containingreplicateddatafromtheplants. Theonlydatacollecteddirectlyfromtheplantisthealarms,whichiscollecteddirectlyfromtheplant alarms&eventsserver.Thisisinordertobeabletoacknowledegalarms.

Theuserrolesfoundonthecentralservercanbefound**here (Section 4.6.1)**.

2. Plant pages

Followingmenuitemsarenormallyavailable(plantdifferences):

**Folder Menu item**

**Plant KPI dashboard (Section 5.6.4.25)**

**Plant overview (Section 4.10.1)**

Plantmonitoring **Overall production**

**overview (Section**

**4.10.2)** Plantmonitoring **String monitor**

**overview (Section**

**4.10.3)** Plantmonitoring **Transformer switch**

**overview (Section**

**4.10.4)**

Plantmonitoring **Inverter details**

**(Section 4.10.5)** Plantmonitoring **Inverter power**

**overview (Section**

**4.10.6)**

Plantmonitoring **Inverter insulation**
...
©2020 My Company. All Rights Reserved.
Sirius SCADA user documentation 75

Plantmonitoring Plantmonitoring Plantmonitoring

Plantmonitoring Plantmonitoring

Reporting–>Plant Reports
...
**Substation (Section 4.10.8)**

**Weather data (Section 4.10.9)**

**Tracker data (Section 4.10.10)**

**PPC data (Section 4.10.11)**

**Alarm list (Section 4.10.12)**

**Inverter downtime summary (Section 4.7.5)**

**Inverter downtime events (Section 4.7.5)**

**Grid downtime summary (Section 4.7.5)**

**Grid downtime events (Section 4.7.5)**

**Tracker downtime summary (Section 4.7.5)**

**Tracker downtime events (Section 4.7.5)**

**Process Explorer (Section 4.7.3)**

**Alarm history (Section 4.7.2)**

**Monthly KPI report (Section 5.6.4.20)**

**Availability details (Section 5.6.4.2)**

**Performance Ratio details (Section 5.6.4.24)**

**Deemed Energy (Section 5.6.4.6)**

**Energy report (Section 5.6.4.7)**

**Weather report (Section 5.6.4.33)**

**Meter report (Section 5.6.4.17)**

**Facility Data (Section 5.6.4.10)**

©2020 My Company. All Rights Reserved.
Sirius SCADA user documentation 88

Reporting **Measured vs.**

**forecast report**

**(Section 5.6.4.18)** Reporting **Daily management**
...
**(Section 5.6.4.14)** Reporting **Tracker data**

**(Section 5.6.4.32)** Analysis **Facility Power Curve**

**(Section 5.6.4.11)** Analysis **External weather**
...
**(Section 5.6.5.3)** Analysis **Process Explorer**

**(Section 4.7.3)**

3. Enterprise pages

Enterprisemenycontainsreportsandscreencommonforwholeenterprise.Followingscreensavailable

- Main folder
  - **World map (Section 5.5.4)**:showsworldmapwithplantstateinformationforeachplant
  - **Enterprise overview (Section 5.5.1)**:showrealtimestateforeachplant
    - **Power overview plants (Section 5.5.2)**:showhistoricalpowerandirradiationvalueforall plants
- Reports:
  - **Daily management report (Section 5.6.4.5)**
  - **Actual vs Budget report (Section 5.6.4.1)**
    - **Operational report selection (Section 5.6.4.23)**
  - **NERSA Report (Section 5.6.4.21)**
    - **Meter vs. adjusted production (Section 5.6.4.15)**
  - **Periodic report (Section 5.6.4.31)**
    - **Weather data details (Section 5.6.4.16)**
  - **Performance ratio details (Section 5.6.4.24)**
    - **Budget report (Section 5.6.4.3)**
  - **Production loss report (Section 5.6.4.30)**
    - **Inverter data (Section 5.6.4.14)**
  - **Monthly report Utility (Section 5.6.4.22)**
    - **User activity report (Section 4.6.4)**
  - **Performance ratio table (Section 5.6.4.27)**
    - **Availability details report (Section 5.6.4.2)**
  - **Monthly KPI report (Section 5.6.4.20)**
    - **Global Daily Management Report (Section 5.6.4.13)**
  - **Periodic KPI report (Section 5.6.4.26)**
    - **FPC Calculations (Section 5.6.4.12)**
  - **FPC Reports (Section 5.6.4.11)**
    - **External forecast report (Section 5.6.4.9)**
      - **Plant curtailment report (Section 5.6.4.28)**
    - **Plant availability details (Section 5.6.4.29)**
- Analysis
  - **Weather data details (Section 5.6.5.6)**
  - **String monitor report (Section 5.6.5.4)**
    - **String monitor report interval (Section 5.6.5.5)**
  - **External weather data report (Section 5.6.5.1)**
    - **Soiling report (Section 5.6.5.3)**
  - **Power BI (Section 5.6.5.2)**
    - **Process Explorer (Section 4.7.3)**
  - Manualinput:
    - **Production adjustment (Section 5.7.1)**:adjustproductionmanuallyforallplants
    - **Irradiation adjustment (Section 5.7.2)**:adjustirradiationvaluesmanuallyforallplants
      - **Budget updates (Section 5.7.3)**:updatebudgetvalues
  - Administration:
    - **Edit system parameters (Section 5.4.1)**:editcommonsystemparameters
      - **Edit plant parameters (Section 5.4.2)**:editplantparametersusedforreporting
    - **App user administration (Section 5.4.3)**:manageusersforapp
    - Development
      - Newfunctionsandreportsunderdevelopment.Onlyavailableforcertainusers.
4. System administration
1. Edit system parameters

Inthisscreen,usercaneditenterprisesystemparameters:

- SCADAdatabasename:configurationdatabasenameofcentralsystem.nottobechanged.
  - Maxappdevicesperuser:maxdevicesperuseridinappbeforeloginisrefused
- Adminemailaddresses:emailaddressesfornotificationsfromsystem.E.g.missingdatawarningsand apploginfailures.

Chagevaluesandpress"Storedata"toupdate

2. Edit plant parameters

ThispageisusedtodefineparametersperplantusedforKPIcalculationsandpresentationinreportsandapp. Selectplant,editdataandpress"Storedata"toupdate.

Followingparameterscanbechanged:

- FirstInstallationDate(dd.mm.yyyy):firstmoduleinstallationdate
  - LastInstallationDate(dd.mm.yyyy):lastmoduleinstallatindate
- AvailabilityNominalBonus(%):nominalavailabilityusedforbonusreporting
  - InitialModuleDegradationBonus(%):initialmoduledegradationusedinPRbonusformula
- YearlyModuleDegradationBonus(%):annualmoduledegradationusedinPRbonusformula
  - AvailabilityNominalLD(%):nominalavailabilityusedforLD/warrantyreporting
- InitialModuleDegradationLD(%):initialmoduledegradationusedinPRwarrantyformula
  - YearlyModuleDegradationLD(%):annualmoduledegradationusedinPRwarrantyformula
- PerformanceRatioNominal(%):nominalperformanceratio(setnormallytoP50value)
  - PerformanceRatioEPCBonus(%):nominalPRforECPbonusreporting
- PerformanceRatioO&MBonus(%):nominalPRforO&Mbonusreporting
- PerformanceRatioO&MLD(%):nominalPRforO&MLD/warrantyreporting
  - PerformanceRatioO&MP50(%):nominalPRforO&MP50reporting
- PerformanceRatioEstimated(%):estimatedPRfordeemedenergyreporting
  - IrradiationatStandardTestConditions(W/m2):irradiationatstandardtestcondition(normally1000)
- WarrantyStartDateEPC(dd.mm.yyyy):startofEPCwarranty
  - WarrantyEndDateEPC(dd.mm.yyyy):endofEPCwarranty
- FirstO&MtermLD/bonusstart(dd.mm.yyyy):startofO&Mbonus
  - O&Mwarrantyinterval(months):warrantyintervaks
- InverterType:maintypeofinverterused
  - NumberOfInverters:numberofinverters
- ModuleType:mainmoduletype
  - NumberOfInstalledModules:numberofinstalledmodules
- Planeofarrayarea(m2):Totalareaofmodulesinplane
  - UseTrackers:usetrackersornot.
- TrackerType:trackertype,iftrackersareused
  - NominalCellTemperature(°C):nominalcelltemperaturefortempadjustedPRcalculations.
- ModulePowerTemperatureCoefficient(%/°C):modulepowertemperaturecoefficient,usedfortemp adjustedPRanddeemedenergycalculations
  - ModuleTempAdjustmentLimit(°C):limitforusingthetemp.adjustmentinPRcalculation
    - Moduleefficiency(%):moduleefficiencyformainmoduletype
  - FlashTestPeakPower(W):nameplatepowerofmodulesinstalled
    - StartProductionDate(dd.mm.yyyy):datewhenreportingincentralsystemstarts
  - FinancialCloseDate(dd.mm.yyyy)
    - ConstructionStartDate(dd.mm.yyyy)
  - ConstructionFinishDate(dd.mm.yyyy)
    - CommercialOperationDate(dd.mm.yyyy)
  - Location:descriptionofplantlocation
    - Coordinates:coordinatesofplantlocation,usedinapp
  - DrivingInstructions:textualdrivinginstructiontosite
    - ContactPerson:ScatecSolarcontactpersonforproject
  - AreaUnderPanels(ha):Totalareaunderthepanels.
    - LocalCurrency:Localcurrencyusedinenergytariff
  - NominalHouseholdCapacity:Numberofhousesestimatedtobefedbyplant.
    - AnnualYieldEstimate(MWh):Estimateoftotalyearlyproduction
  - GlobalEmmisionFactor:FactorusedtocalculateCO2equivalentemissionsfromenergyproduction
3. App user administration

Pagetoadministrateappusers.

Addnewuseroreditexistingfromuserlist.Listonlyshowsusersenabledforappaccess(alsosee**User administration (Section 4.6.1)**).

Rolesavailableforuserisonlyrelatedtoapp:

- App\_Enterprise:seealldataforallplants
  - App\_<plantnam>\_Budget:seebudgetdataforplant
- App\_<plantnam>\_Production:seeproductiondataforplant

Isusereditpage,followingactionstobedone:

- Enter/changeusername,passwordanddescription
  - Selectuseraccessselectingroles
- DevicesshowsID'sfordevicesusedtologinwiththisusername.Ifnumberofdevicesisexceeded,"Clear

devices"canbepressedtoremovedevicesinlogandenableusertologinagain.

4. Weather station setup

This page is used to activate/deactivate measurements and recalculate sensor data for individual weather stations used in reporting.

Select facility and weather station and select parameters to be changed. Then click “Store data”. Following parameters can be changed:

**Tracker for incline pyranometer**

- Select tracker connected to pyranometer:
  - Tracker connected to incline pyranometer.
    - UsedtofilteroutinclinepyranometervaluesfromKPIcalculationswhentrackerisoutoforder (nottracking)
  - Disable tracker status filtering: Disable tracker from filter.
    - Ifset,trackerstatusisnotusedforfiltering

**Reference cells**

- Use ref. cell for soiling:
  - Set if a reference cells are present and used for the soiling measurements.
- Has reversed ref. cells:
  - Set if reference cell clean/dirty is switched according to the standard setting.
- Last ref. cell cleaning date (dd.mm.yy):
- The last cleaning date of the reference cell. When changed, soiling data is recalculated.

**Sensors out of order (exclude from reporting)**
...
Theenterpriseoverviewscreenshowsmainstatusdataforeachplant:

- Country
  - Site
- Nom.power
  - Comm:communicationstatusforsitegreen/red
- Grid:gridstatuson/off
  - Inv:inverterstatus,greenifallOK,yellowifmorethan1infailure,redifmorethan2infailure
- Tracker:trackerstatus,greenifallOK,yellowifmorethan1infailure,redifmorethan2infailure
  - Local time
- Gridpower:currentvalue
- Irradiation:currentinclineirradiation
  - Amb.temp.:currentambienttemperature
- Moduletemp.:currentmoduletemperature
  - Lastactivealarmnotacknowledged
2. Enterprise power overview

Showsgridpowerandinclineirradiationforallplants:

![](yryhdz2b.069.png)

3. CMC regional overviews

Thesescreensshowsdataforoneregion.Clickingononeplant,zoomsintothatplant. Followinginformationelements:

- Header:
  - Currentproductionforregion
    - Name of region
  - Totalenergyproductionforregion
  - Infoperplant
    - Powergaugearea:showsrealtimevaluesforpower,voltageandcurrent
      - Weatherinfoarea:realtimevaluesforweatheronplant.WeathersymbolfromYr.
    - Communicationlinks:clickone.g.emailsymboldtoopenemailforplantcontactperson
      - Charts:
        - Inverter:inclineirradiationperstationsvs.inverterpowerinaradarcharts
          - Powerdifference:percentagedifferencefromaverageforallinveters.
        - Production:powervs.irradiance
    - Status area:
      - Showsmainstatusforplant ![](yryhdz2b.070.png) Green: number of OK ![](yryhdz2b.071.png) Yellow:numberofwarning ![](yryhdz2b.070.png) Red:numberofalarm/error ![](yryhdz2b.071.png) Grey:numberofnotconnected
        - ClickingonstatusopensPlantOverviewpage
      - ![](yryhdz2b.072.png)Inverterstatus.Clickingonsymbolopensinverterdetailspage.
    - ![](yryhdz2b.073.png)Trackerstatus.Clickingonsymbolopenstrackeroverviewpage.
      - ![](yryhdz2b.074.png)Gridconenctionpointstatus.Clickingonsymbolopensgridtransfoermerswitch overview.
      - ![](yryhdz2b.075.png)Stringmonitoringstatus.Clickingonsymbolopensstringmonitoringoverview page.
        - ![](yryhdz2b.076.png)Communicationstatuswithplant
- Statustower:Showssummarizedstatusforinverters,trackersandgrid
  - PPCsetpoints:showsmainPPCsetpointvaluesandstatus
- Invertergrid:Showsstatusforallinverters.Clickingoninverteropensinverterdetailspage.
  - Alarmlistshowsactivealarmsthathavenotbeenacknowledged.
4. CMC world map

Thisscreenshowsstatusforallplants.

- Header:showsmainstatusforScatecportfolio
  - Footer:showsrolligstatusforallplants
- Main area:
  - Worldmapwithsolarcurve
    - Gaugeshowingcurrentproductionineachregion
  - Symbolshowingstateofeachplant
    - Green: OK
      - Yellow:warning,oneormoreproblemsonsite
    - Red:alarm,moreseriousproblemsonsite
      - Grey:notproducing
    - Greywithorangeborder:notconnected
      - Hoverplantimagetoshowdetailsforplant.Willdisappearwhenmovingaway.
    - Clickplantimagetoshowandkeepstatusforplant.Clickagaintoremove
  - Addcountrybordersusing ![](yryhdz2b.077.png) symbol
    - Zoomin/outusing ![](yryhdz2b.078.png) and ![](yryhdz2b.079.png)
  - Restorezoomusing ![](yryhdz2b.080.png)
6. Central reports
1. Data warehouse basics

See **Data warehouse database (Section 4.2.8)**forgeneralconcepts.

2. Central report concepts

See **Data warehouse reports (Section 4.7.4)[forageneraldescriptionofthereportingtoolusedf](designcommand:name=edit,id='310db16d-2220-49ac-9155-1a23e8168169')**orcentral reports.

3. Reporting overview

Followingreportsavailable:
...
Reportshowsactualvs.budgetnumbersforfollowingperiods:
...
For"Todate"numbers,actualvs.budgetanddifferenceisshown.

For"Fullperiod",forecastvs.budgetanddifferenceisshown.Forecastismeasuredvaluestodateaddedbudget numbersforrestofperiod.

Followingparametersareshown:
...
Resultandsubparametersofavailabilitycalculations,basedonplantformula. Dataiscaclulatedforatimeperiodandpresentedasnumbers. Inputparameter:

- StartandEndperiod:usedifnotperiodisused.Un-checkbothboxesbeforeuse.
  - Periodtypeandperiod:selectreportperiodifnotstartandendtimeisused
- Reportdescription:usedintheheadingofthereport

Reportelements:

- Plantavailability:
  - Totalinverterdowntime(minutes):totaldowntimeforallinvertersinsum(Failureandidle time)fromstateregistration
    - Totalinvertertime(minutes):totalinvertertimeassum
      - Plantavailability(%):plantavailability,asTotalinverterdowntimeaspercentoftotalinverter time
  - Plantavailabilitynominal(%):Nominalavailabilitysetinplantparameters
  - Grid/facilityavailability:
    - Totaldowntimegrid(minutes):totalgriddowntimefromstateregistration
      - Totalgridtime(minutes):totaltime
    - Gridavailability(%):gridavailabilitycalculatedastotaldowntimeaspercentageoftotaltime
    - Inverternon-operationperinverter:Sumofnon-operationaltimeperinverter
- Inverternon-operationdetails:eachnon-operationaltimeperiodforeachinverter
  - Grid/facilitynon-operationdetails:eachgridnon-operationalstate
3. Budget report

Thisreportshowsbudgetnumbersforafacility. Usercanselectthefollowing:
...
Reportaggregatesmainbudgetnumbers:

- HorizontalIrradiation(kWh/m2)
  - InclineIrradiation(kWh/m2)
- NetProduction(kWh)
  - PlantAvailabilityDaylight(%)
- GridAvailabilityDaylight(%)
  - PerformanceRatioNet(%)
- PerformanceRatioGross(%)
  - Nettariff(ZAR/kWh)
4. CDM Energy Report

ThisreportsshowsenergymeterdataontheCDMformat. Dataisgroupedinintervals.
...
- Interal:startandendtime
  - Mainmeterreadings
    - Electricitysuppliedtothegrid(EGexport\_M)
      - Electricitysuppliedbythegrid(EGimport\_M)
    - Backupmeterreadings
      - Electricitysuppliedtothegrid(EGexport\_B)
        - Electricitysuppliedbythegrid (EG import\_B)
5. Daily management report

Thisreportsshowsdatafordailyreporting. Inputparametersare:

- Report date
  - Facility(onlyenterprisereport,fixedinplantreport)

Reportdataisshowninthreemaintimeperiods:

- Reportdate:dataforselecteddate
  - Monthtodate:datafromstartofmonthuptoselecteddate
- Yeartodate:datafromstartofyearuptoselecteddate

Followingdataisshownintable:

- Production: **manually adjusted production numbers (Section 5.7.1)**
  - IrradiationHorizontalPlane(Average)
- IrradiationFixedTitlPlane(Average):calculatedifnomeasurement
  - IrradiationTrackedPlane(Average):onlywheretrackersareinstalled
- Temperatureambientmin:minimumambienttemperature
  - Temperatureambientmax:maximumambienttemperature
- Temperatureambientavg:averageambienttemperature
  - Temperaturemodulemax:maximummoduletemperature
- Plantavailabilitydaylight(Inverterlevel):availabilityduringdaylight
  - Plantavailabilityfullday(Inverterlevel):availabilityforwholeday
- Gridavailabilitydaylight:gridavailabilityduringdaylight
  - Gridavailabilityfullday:gridavailabilitywholeday
- Trackeravailabilitydaylight:availabilityoftrackersduringdaytime
  - **Performance ratio contractual LD (Section 4.7.7.4)**
- **Performance ratio contractual Bonus (Section 4.7.7.4)**
  - **Performance ratio net (Section 4.7.7.4)**
- **Performance ratio gross (Section 4.7.7.4)**
  - OverperformanceinRelationtoBusinessCase:
    - 0.5\*Production\*(PerformanceRatio(contractual)-81.1)/PerformanceRatio(contractual) 81,1isplantdependent

ReportisfoundundertheEnterprisemenu.

6. Deemed energy

Thisreportshowsdatausedfordeemedenergypaymentcalculations. Energycalculationsisbasedon**manually adjusted production (Section 5.7.1)** numbers. Inputparameter:

- Startandenddateandtime
  - numberofprecedingdays
- Reportdescriptionforheader

Reportelements:

- Deemedenergyfactors:
  - Facilityavailability-FA(%):plantavailabilityfromplantavailabilitystandardcalculations
    - Energyoutputfactor-E/Es:factorforcalculatingtheoreticalenergyproductionbasedon irradiation
      - Expectedenergyoutput-EO(MWh):theoreticalenergyproductionbasedonirradiation
- Dailyvalues,energyoutputandirradiation:
  - Backgroundvaluesforabovefactors
  - Grid/facilitynon-operationcausedbyEskom:TableshowingallgridstatesindicatingEskomfailure
    - Irradiancevaluesforperiod:10minuteaverageinclineirradiationmeasurementforperiod
7. Energy Report

Thisreportsshowsenergymeterdatagroupedinintervalsandpresentedintableformat. Inputparameter:
...
- Interval
  - Period name
    - StarttimeandEndtime
  - Meterreadings
    - Activeenergyfeedin(MWh)
      - Activeenergyconsumption(MWh)
    - Reactiveenergyfeedin(MVArh)
      - Reactiveenergyconsumption(MVArh)**Manually adjusted production (Section 5.7.1)** (MWh)
8. Energy feed-in report

Thisreportsshowsactiveenergyfeed-inmeterdatagroupedinintervalsandpresentedintableformat. Inputparameter:

- StartandEndperiod:usedifnotperiodisused.Un-checkbothboxesbeforeuse.
  - Periodtypeandperiod:selectreportperiodifnotstartandendtimeisused
- Reportdescription:usedintheheadingofthereport
  - Interval:datagroupinginterval(default30min)
...
- Interval
  - Period name
    - StarttimeandEndtime
  - Meterreadings
    - Activeenergyfeedin(MWh):**manually adjusted production numbers (Section 5.7.1)**
9. External forecast report

Thisreportsshowsexternalforecastdata. Inputparametersare:

- StartandEndperiod:usedifnotperiodisused.Un-checkbothboxesbeforeuse.
  - Periodtypeandperiod:selectreportperiodifnotstartandendtimeisused
- Continent:filtercontinent
  - Country:filtercountry
- Facility:selectplant
  - Reportdescription:titleforreport
- Interval:thetimeintervalusedwithinthereportperiod,usedfordataaggregation
  - Forecasttype:oneoftheavailableforecasts
    - PVSYST
      - SolarGIS rolling
    - SolarGISweekahead
    - Power forecast:
      - Gross,withoutavailability
        - Net,withavailabilityforecast
  - Externalweatherdata:whatexternalweatherdatasourcetoshowinreport

Followingdataisshown:

- Powerproductionchart
- Poweravailabilitychart
  - Horizontalirradiationchart
- Inclineirradiationchart
  - Environmenttemperaturechart
- Windspeedchart
  - Tablewithforecastandmeasuredvalues,includingdifferences
- Chartwithpowerdiffererences,measuredvs.forecast
10. Facility data

Reportshowingdetaileddeliverypointdataforplantintableformat. Inputparameter:
...
- Deliverypointdata:All10minutevaluesfromFactdeliveryPointtable
11. FPC report Reportshows10minutedataforFPCreportbasedoncontractualrequirements.

Dataispresentedintabularformat.
...
- Starttime(dd.mm.yyyyhh:mm:ss):starttimeof10minuteperiod.
  - Endtime(dd.mm.yyyyhh:mm:ss):endtimeof10minuteperiod
- Facilityenergyoutput(MWh):Energyproductionof10minuteperiod.**Manually adjusted production numbers (Section 5.7.1)**.
  - Inclineirradiance(W/m2):averageinclineirradiationof10minuteperiodgroupedin50Wbins.
    - Moduletemperature(°C):averageenvironmenttemperatureof10minuteperiodgroupedin5°Cbins.
12. FPC Calculations

ReportshowingFPCcalculationparametersbasedonFPCreport.

13. Global daily management report

Thisreportsshowsdailyreportingdataforaselectionofsite. Inputparametersare:

- Report date
  - Continent:filtercontinent
- Country:filtercountry
  - Facilities:oneormoreplants

Followingdataisshown:

- Dashboardforallplantsselected
  - Per plant
    - Invertercurve,min,maxandaverage
      - Mainparametersvs.budget
    - Downtimeandperformanceratio
      - Plantcomments
14. Inverter data

Reportshowsdataperinverterforoneormorefacilities. User selects:

- Period
  - Facilities(onlyenterprisereport,fixedinplantreport)

Followingdataisshownaggregatedintableperinverter:

- PowerNominal(Kw)
  - Energyproduction(kWh)
- AverageActivePower(kW)
  - AverageReactivePower(kVAr)
- DownTime(minutes)
  - EstimatedProductionLoss(kWh)
15. Meter vs. adjusted production

Thisreportsshowsdataformanualproductionadjustment.

©2020 My Company. All Rights Reserved.
Sirius SCADA user documentation 

Meterreadingvaluesareshowntogetherwiththeadjustedproductionvalue.Thediffe areshowninaseparatecolumn.

Intable2,thelogforeachsinglechangeintheproductionvalueisshown. Inputparameter:

- StartandEndperiod:usedifnotperiodisused.Un-checkbothboxesbefore
  - Periodtypeandperiod:selectreportperiodifnotstartandendtimeisused
- Interval:datagroupinginterval
  - Continents,countriesandfacility.
- Reportdescription:usedintheheadingofthereport

rencebetweenthetwovalues

use.

©2020 My Company. All Rights Reserved.
Sirius SCADA user documentation 114

ReportisfoundundertheEnterprisemenu.

16. Meter detail reports

Reportshowingdetailedmeterdataforplantintableformat. Inputparameter:
...
- Meterdetaileddata,feedin:All10minutevaluesforfeed-inmeasurementsfromallenergymeters
  - Meterdetaileddata,consumption:All10minutevaluesforconsumptionmeasurementsfromallenergy meters
17. Meter report

Reportshowingmeterdataforplant. Graphsandtable.
...
- Feedinactiveenergy:activeenergyproductionongridperintervalshowninbargraph
  - Feedinreactiveenergy:reactiveenergyproductionongridperintervalshowninbargraph
- Meterdata,energymainmeters:activeandreactiveenergyperintervalfrommainenergymeters
  - Meterdatapower,averagevalues:activeandreactivepowervaluesinaverageforallmeters
- Meterdataenergyperinterval:energymeasurementfroallmetersperinterval
  - Meterdataenergytotalmeterreading:maxtotalenergymeterreadingforallmetersperinterval
- Meterdataadditionalparameters:voltage,current,frequencyandpowerfactorfromtransducers
18. Measured vs forecast

Reportshowingmeasureddatavs.forecastdata. Measuredenergyfeed-invalues,aremanuallyadjustedproductionmeasures. Graphsandtable.
...
- Facilityenergyproductionvs.forecast:bargraph
  - Environmenttemperaturevs.forecast:bargraph
- Inclineirradiationvs.forecast:bargraph
  - Horizontalirradiationvs.forecast:bargraph
- Forecastvs.measureddata:tabulardataforallforecastparameters
19. Missing facility data

Reportshowingmissingdeliverypointdataforplantintableformat. Reportisforsuperuser.
...
- Missingdeliverypointdata:All10minuteintervalshavingoneormoremissingmeterorweathervariable

inthedatawarehouse

20. Monthly KPI report

Themonthlyreportcontainsdataaggregatedforamonthforaspecificplant.Reportisfoundinmenuforeach plant.

Thereporthasacommontemplateadaptedtoeachplant. Inputparameter:
...
- Maindashboardformonthandyear
  - Actualandbudgetvalues
    - Differenceandarrowindicationaboveorbelow
  - Tablesshowingbudget,actualsanddifferenceforlast12months
    - Monthlyproductionandrevenue
      - Yeartodateproductionandrevenue
    - Monthlyweather
      - Monthlyavailability
    - Monthlyperformanceratio
- Monthlychartscurrentyear
  - Dailychartscurrentmonth
- Plantreportcomments
  - Analysistree,yeartodateandlastmonth
21. NERSA report

ThisreportsshowsdatafortheSouthAfricanplantinaformatforgeneratingtheNERSAreport. Inputismonth,intervalandfacility. Manuallyadjustedproductionnumbersareusedforactualenergyproduction. ReportisfoundundertheEnterprisemenu.

22. Monthly report utility

Themonthlyreportutilitycontainsdataaggregatedforamonthforaspecificplantadaptedtoutilityneeds. Inputparameter:
...
- Productiontable
  - Feedinactiveenergy(MWh):showsdataforeachmainenergymeterandtotalforplant
    - Feedinre-activeenergy(MVArh):showsdataforeachmainenergymeterandtotalforplant
  - Totalproductionmanuallyadjusted:**production number adjusted manually (Section 5.7.1)**(defaultsameasmetervalues)
- Productionperdaygraph
  - Activefeed-inenergyproduction.Theadjustedproductionvalueisshown.Bargraphperday.
  - Productionperdaytable
  - Accumulatedinclineirradiationperday
    - kWh/m2values,aggregatedbasedontheaverageinclineirradiationmeasurementfromthe inclinepyranometers
  - Temperatureperday
    - Plantavailability
      - Availabilitytableforwholemonth ![](yryhdz2b.081.png) Non-operationaltime(minutes):totalnonoperationtimeforinverters,summedup for month based on **Inverter state (Section 4.3.2)[.Failuretimeandidletimeare ](designcommand:name=edit,id='1c263e28-dd25-47b7-8ee5-e55d324f758c')**countedasnon-operationaltime.Seealso**Plant availability calculation (Section 4.7.7.1) ![](yryhdz2b.082.png)** Non-operationaltime(ddhh:mm:ss):Sameasabovebutpresentedasdays,hours, minutesandseconds ![](yryhdz2b.081.png) Plantavailabilitymeasured(%):**plant availability (Section 4.7.7.1)** calculated based on **Inverter state (Section 4.3.2) ![](yryhdz2b.083.png)** Contractualavailability(%):contractualavailabilityforplantsetin**Plant parameters general (Section 4.5.3)**
        - **Plant availability (Section 4.7.7.1)**perdayingraphcalculatedbasedon**Inverter state (Section 4.3.2)**
  - Gridavailability
    - Availabilitytableforwholemonth ![](yryhdz2b.083.png) Non-operationaltime(minutes):totalnonoperationtimeforgrid,summedupfor month based on **Grid state (Section 4.3.4)**.Failuretimeandidletimearecounted asnon-operationaltime.Seealso**Grid availability calculation (Section 4.7.7.2) ![](yryhdz2b.083.png)** Non-operationaltime(ddhh:mm:ss):Sameasabovebutpresentedasdays,hours, minutesandseconds
      - Gridavailabilitymeasured(%):calculatedbasedon**Grid state (Section 4.3.4)**.
    - **Grid availability calculation (Section 4.7.7.2)**perdayingraphcalculatedbasedonGrid state
- Inverternon-operation
  - Tablewithsummarizednon-operationaltimeperinverter
    - Shownasminutes,timespanandpercentage
  - Grid/facilitynon-operation
    - Tablewithallnon-operationaltimeperiodsforgrid
      - Perioddurationshownasminutes,timespanandpercentage
  - Trackernon-operation(onlyforplantswithtrackers)
    - Tablewithsummarizednon-operationaltimeforperiodpertracker
    - Shownasminutes,timespanandpercentage
23. Operational report

Thisreportsshowsoperationaldataaggregatedonamonthlybase. Dataisshownpermonthfromstartofproductionofthefirstplant(September2013). **Manually adjusted production numbers (Section 5.7.1)** are used. ReportshallincludeallmainKPI'sinScatecreportingstructure.

24. Performance ratio details

Resultandsubparametersofperformanceratiocalculations,basedonplantformula. Dataiscalculatedforatimeperiodandpresentedasnumbers.
...
- Performanceratio(%):longtermperformanceratiocalculatedforperiodbasedonformula
  - Measuredyield(MWh):measuredyieldforperiod.Energyproductionbasedonmanuallyadjusted production.
    - Nominalpower(MW):nominalDCpowerforplantfromplantparameters
      - Irradianceincline(Wh/m2):measuredinclineaccumulatedirradiationforperiod
    - Irradiancestandard(W/m2):plantconstantfromplantparameters
      - Moduledegradationfactor:plantconstantfromplantparameters
    - Downtimecoefficient-Kd:calculationbasedonformula
      - Nominalplantavailability(%):plantconstantfromplantparameters
    - Firstinstallationdate(dd.mm.yyyy):plantconstantfromplantparameters
      - Lastinstallationdate(dd.mm.yyyy):plantconstantfromplantparameters
25. Plant dashboard

TheplantdashboardpresentseveralmainKPI'sformonthandyear. Thefollowingdataispresented:

- Revenue
  - Measureddataismanuallyadjustedenergyproductionmultipliedbyenergyprice
  - Forecastdataisforecastenergyproductionmultipliedbyenergyprice
  - Energyproduction
    - Measureddataismanuallyadjustedenergyproductionmultipliedbyenergyprice
      - Forecastdataisforecastedenergyproduction
    - Gridavailability
      - Measureddatais**grid availability (Section 4.7.7.2)**calculatedby**state registrations (Section 4.3.4)**
        - Forecastdoesnotexist
- Plantavailability
  - Measureddatais**plant availability (Section 4.7.7.1)**calculatedby**state registrations (Section 4.3.2)**
    - Forecastvalueiscontractualvalueregistered
  - Performanceratio
    - Measureddatais**performance ratio (Section 4.7.7.4)**calculatedbyformula
      - Forecastiscontractualvalueperplant
    - Irradiance
      - MeasureddataisaccumulatedirradiancefromFactDeliveryPoint
      - ForecastisaccumulatedirradiancebasedoninitialforecastinFactForecast
- Inverterfailurerateandrepairtime
  - Measureddataiscalculatedbasedon**state registrations as explained (Section 4.7.7.3)**
  - Forecastisfixedgoal
  - Gridfailurerateandrepairtime
    - Measureddataiscalculatedbasedon**state registrations as explained (Section 4.7.7.3)**
      - Forecastisfixedgoal
- Energyproductionpreviousmonths
  - Bargraphpermonthwithmeasureandforecast
    - MeasuredvaluefromFactDeliveryPointwithenergyfrommainmeters
  - ForecastvaluefromFactForecast(initialforecast)
  - Performanceratioperviousmonths
    - Bargraphpermonthwithmeasureandforecast
      - Measureddatais**performance ratio (Section 4.7.7.4)** calculated by formula for each month
    - Forecastiscontractualvalueperplant
    - Plantavailabilitypreviousmonth
      - Bargraphpermonthwithmeasureandforecast
      - Measureddatais**plant availability (Section 4.7.7.1)**calculatedby**state registrations (Section 4.3.2)** for each month
        - Forecastvalueiscontractualvalueregistered

'

26. Periodic KPI report

ThisreportsshowsKPIdataforoneplantforaperiod. Inputparametersare:
...
- TableswithKPIdata
  - Actuals
    - Budget
  - Differencewithcolorindication
    - EPI:productionindex
  - Actualstodate:measuredvs.budget
    ...
    - Last 12 months
    - Fullperiodforecast
      - Forecastvalues(actuals+budget)vs.forecast ![](yryhdz2b.081.png) Month
      - Quarter ![](yryhdz2b.084.png) Year
  - Tableswithproductionlossdata
    - Plantdowntime
    - Grid downtime
      - Trackerdowntime
    - Soiling losses
    - Dailycharts
      - Chartsforplantwithinselectedreportingperiod
27. Performance ratio table

Thisreportsshowsperformancerationumbersforperiodandinterval. Inputparametersare:
...
- TableshowingPRvalueswithdifferencedefinitions/calculations
  - See **Performance ratio calculation (Section 4.7.7.4)**
28. Plant curtailment report

Thisreportsshowspowercurtailmentdatawithestimatedlossesforaplant. Inputparametersare:
...
- Curtailmentlossescalculatedasin**Curtailment losses (Section 4.7.7.8)**
  - Tableshowingsummarizedlossesforperiod
- Chartsshowingcurtailmenttimeandlosses.
  - Chartshowingestimatedpowervs.measured
- Tableshowingcurtailmentdataperinterval
  - Tableshowingdatafortheindividualregisteredcurtailmentperiods
29. Plant availability details

Thisreportsshowsdowntimeandavailabilitydataforaplantsplitintoeachcategory. Inputparametersare:
...
- Overalldowntimedata
  - Chartsperdowntimecategory
- Tableperdowntimecategory
  - Tableshowingnonoperationaldataperinverter
- Tableshowingsummarizenonoperationaldataperinverterandcategory
  - Tableshowingeachnonoperationalstateperinverter
30. Production loss report

Thisreportsummarizesproductionlossestimatesbasedonequipmentdowntime. User selects:
...
Followingparametersareaggregatedandshownintable:

- Production(MWh)
  - PlantDowntimeTotal(minutes)
- PlantDowntimeperInverter(minutes)
  - PlantDowntimeProductionLoss(MWh)
- PlantDowntimeRevenueLoss(ZAR)
  - PlantAvailabililtyProductionLoss(%)
- PlantAvailabililtyDaylight(%)
  - GridDowntime(minutes)
- GridDowntimeProductionLoss(MWh)
  - GridDowntimeRevenueLoss(ZAR)
- GridAvailabililtyProductionLoss(%)
  - GridAvailabililtyDaylight(%)
- PR net (%)
  - PR gross (%)
- PRgrossProduction
31. Periodic report

Theperiodcreportcontainsdataaggregatedforaperiodforaspecificplant.Reportisfoundinmenuforeachplant. Thereporthasacommontemplateadaptedtoeachplant.
...
- Productionperdaygraph
  - Activefeed-inenergyproduction.Theadjustedproductionvalueisshown.Bargraphperday.
  - Performanceratio
    - **Performance ratio (Section 4.7.7.4)**valueforwholemonth
      - **Performance ratio (Section 4.7.7.4)**perdayingraph
- Accumulatedinclineirradiationperday
  - kWh/m2values,aggregatedbasedontheaverageinclineirradiationmeasurementfromthe inclinepyranometers
- Environmenttemperatureperday
  - Min,maxandaverageenvironmenttemperatureforeachday,basedonaverage10minute measurementsfromweatherstations
- Rainamountperday
  - Accumulatedrainamountbasedonrainintensity.Sumof10minutevalues.
  - Plantavailability
    - Availabilitytableforwholemonth ![](yryhdz2b.085.png) Non-operationaltime(minutes):totalnonoperationtimeforinverters,summedup for month based on **Inverter state (Section 4.3.2)[.Failuretimeandidletimeare ](designcommand:name=edit,id='1c263e28-dd25-47b7-8ee5-e55d324f758c')**countedasnon-operationaltime.Seealso**Plant availability calculation (Section 4.7.7.1)**
      - Non-operationaltime(ddhh:mm:ss):Sameasabovebutpresentedasdays,hours, minutesandseconds ![](yryhdz2b.085.png) Plantavailabilitymeasured(%):**plant availability (Section 4.7.7.1)** calculated based on **Inverter state (Section 4.3.2) ![](yryhdz2b.082.png)** Contractualavailability(%):contractualavailabilityforplantsetin**Plant parameters general (Section 4.5.3)**
    - **Plant availability (Section 4.7.7.1)**perdayingraphcalculatedbasedon**Inverter state (Section 4.3.2)**
    - Gridavailability
      - Availabilitytableforwholemonth ![](yryhdz2b.082.png) Non-operationaltime(minutes):totalnonoperationtimeforgrid,summedupfor month based on **Grid state (Section 4.3.4)**.Failuretimeandidletimearecounted asnon-operationaltime.Seealso**Grid availability calculation (Section 4.7.7.2) ![](yryhdz2b.082.png)** Non-operationaltime(ddhh:mm:ss):Sameasabovebutpresentedasdays,hours, minutesandseconds ![](yryhdz2b.084.png) Gridavailabilitymeasured(%):calculatedbasedon**Grid state (Section 4.3.4)**.
      - **Grid availability calculation (Section 4.7.7.2)**perdayingraphcalculatedbasedonGrid state
- Trackeravailability(onlyforplantswithtrackers)
  - Availabilitytableforwholemonth
    - Non-operationaltime(minutes):totalnonoperationtimefortrackers,summedupfor month based on **Tracker state (Section 4.3.3)**.Failuretimeandidletimeare countedasnon-operationaltime.Seealso**Tracker availability calculation (on- line documentation)**
      - Non-operationaltime(ddhh:mm:ss):Sameasabovebutpresentedasdays,hours, minutesandseconds
    - Gridavailabilitymeasured(%):calculatedbasedon**Tracker state (Section 4.3.3)**. See also **Tracker availability calculation (on-line documentation)**
  - **Tracker availability calculation (on-line documentation)**perdayingraphcalculated based on **Tracker state (Section 4.3.3)**
- Inverternon-operation
  - Tablewithsummarizednon-operationaltimeperinverter
    - Shownasminutes,timespanandpercentage
- Grid/facilitynon-operation
...
Thetrackerreportcontainsdatafortrackersforaspecificplant.Thisreportexistonlyforplantswithtrackers. Inputparameter:
...
- Trackeravailability
  - Availabilitytableforwholeperiod
    - Non-operationaltime(minutes):totalnonoperationtimefortrackers,summedupfor month based on **Tracker state (Section 4.3.3)**.Failuretimeandidletimeare countedasnon-operationaltime.Seealso**Tracker availability calculation (on- line documentation)**
      - Non-operationaltime(ddhh:mm:ss):Sameasabovebutpresentedasdays,hours, minutesandseconds
    - Gridavailabilitymeasured(%):calculatedbasedon**Tracker state (Section 4.3.3)**. See also **Tracker availability calculation (on-line documentation)**
  - **Tracker availability calculation (on-line documentation)**perdayingraphcalculated based on **Tracker state (Section 4.3.3)**
- Trackernon-operationpertracker
  - Tablewithsummarizednon-operationaltimeforperiodpertracker
    - Shownasminutes,timespanandpercentage
  - Trackernon-operationdetails
    - tableshowingeachnon-operationaltimeperiod
      - Showsstarttime,endtime,durationandcomment(ifaddedmanually)
33. Weather report

Reportshowingweatherdataforplant. Graphsandtable.
...
- Temperaturedata:environmentandmoduletemperatureaslinegraph
- Irradiationdata:allirradiationmeasurementtypesasaveragevaluesinlinegraph
  - Accumulatedirradiation:accumulatedinclineirradiationvaluesforfacilitybasedonaverageincline irradiationvaluesfrompyranometers
    - Missingandestimatedvaluesshownbelowgraph
  - Winddirection:averagewinddirectionperintervalshowninlinegraph
- Windspeed:average,minandmaxwindspeedperintervalshowninlinegraph
  - Rainamount:accumulatedrainamountperintervalshowninbargraph
- Humidity:average,minandmaxhumidityperintervalshowninlinegraph
  - Airpressure:average,minandmaxairpressureperintervalshowninlinegraph
- Environmenttemperature:average,minandmaxenvironmenttemperatureperintervalshowninline graph
  - Measuredweatherdataforallmeters:aggregateddataperintervalforeachweatherstation
5. Analysis guide
1. External weather data report

ThisreportsshowsexternalweatherdataloadedfromSolarGISorothersource. Inputparametersare:
...
- Facility:selectplant
  - Reportdescription:titleforreport
- Interval:thetimeintervalusedwithinthereportperiod,usedfordataaggregation
  - Externaldatasupplier:whatexternalweatherdatasourcetoshowinreport

Followingdataisshown:

- Chartsshowingmeasuredvs.externaldata
  - Scatterplotsshowingmeasuredvs.externaldata
- Tableshowingmeasuredvs.externaldataanddifference
  - Chartshowingdifferencesinpercentperinterval
2. Power BI

PowerBIcanbeusedforexternaladhocanalysis. Needextrasignin

More to come

3. Soiling report

Thisreportsshowssoilingestimationsand/ormeasurementsdata. Inputparametersare:
...
- Facility:selectplant
  - Reportdescription:titleforreport
- Interval:thetimeintervalusedwithinthereportperiod,usedfordataaggregation
  - Weatherstationstouseinreport
- Minandmaxvaluesoncharts

Followingdataisshown:

- Chartwithsoilingaverageandrainamount
  - Chartwithsoilingperweatherstation
- Chartswithestimatedlosses
  - Tablewithaveragesoilingandrainvalues
- Tablewithsoilingvaluesperweatherstation
4. String monitor report

Reportshowingstringmonitorperformanceperstringchannel. Notforallplants,requiressetupofstringsingrid. Inputparametersare:
...
- Continent:filtercontinent
  - Country:filtercountry
- Facility:selectplant
  - Namefilter:Stringchannelfilter
- Warninglevel1,2and3

Followingdataisshown:

- Tablewithsummarydata
  - Chartwithaveragestringenergyperchannelwithaverageandcolorcoding
- Chartwithaveragestringenergypercombinerboxwithaverageandcolorcoding
  - Chartwithaveragestringenergyperinverterwithaverageandcolorcoding
- Tablesshowingstringmonitordata
  - Powerandenergyvalues
    - Energyrelativetogroupenergy(%)
  - Numberofcontinousdaysbelowwarning3level
    - Numberofcontinousdaysbelowwarning2level
  - Numberofcontinousdaysbelowwarning1level
  - Heatmapshowingstringsinmapwithcolorcoding

![](yryhdz2b.086.jpeg)

![](yryhdz2b.087.jpeg)

5. String monitor report interval

Reportshowingstringmonitorperformanceperstringchannelandday. Notforallplants,requiressetupofstringsingrid.
...
- Tableperintervalandstringchannel.
  - Relativeenergyvalues
    - Color coding
...
- Tableswithweatherdataper10minuteperiod¨
  - Onevalueforeachmeasurement
    - Columnforaveragedata
  - Columnformodifieddata
    - Onecolumnforeachstation
  - Value
    - Redtextand\*symboldifqualityofvaluesisclassifiedasbad
7. Manual data registrations
1. Production adjustment

Productionadjustmentisusedtomanuallyadjustfeed-inenergynumberscomingfromthemeters.Thiscanbeused whentechnicalproblemshasresultedinwrong/missingdata,whenenergymeasurementisnotpresentortoadjust numberstoalignwithutilitymeterreadings.

Dataisenteredin30minuteintervals.

Userselectdayandplant,andenergydataisdisplayedintable:

- Starttime:starttimeofproductionperiod
  - Endtime:endtimeofproductionperiod
- Feedinenergyfrommeter(kWh):valuereadfrommeter
  - Existingproductionmanuallyadjusted(kWh):valueadjusted(defaultsameasmetervalue)
- Newproductionmanuallyadjusted(kWh):inputfieldfornewadjustedvalue
  - Lastchangedtime:timeoflastchangeofadjustedvalue
- Lastchangedbyuser:userlastchangingthevalue
  - Lastchangedreason:reasonforlastchange
- Lastchangedcomment:commentonlastchange

Theproductionvaluecanbeadjustedinthetableforeach30minute.

Commonreasonandcommentforallchangescanbeenteredbeforesavingthedata.Dataissavedpressingthe "Savechanges"button.

2. Irradiation adjustment

Irradiationadjustmentisusedtomanuallyadjustinclineandhorizontalirradiationnumberscomingfromtheplant. Thiscanbeusedwhentechnicalproblemshasresultedinwrong/missingdata.Emailissenteverydaytomail addresssetin"Adminemailaddresses"is**System parameter (Section 5.4.1)**settingswithperiodsmissing irradiationdata.

Dataisenteredin10minuteintervals. Userselecttype(incline/horizontal),dayandplant,andirradiationdataisdisplayedintable:

- Starttime:starttimeofproductionperiod
  - Endtime:endtimeofproductionperiod
- Irradiationmeasured(Wh/m2):valuefrommeter
  - Irradiationexisting(Wh/m2):exitsingvalueforreporting
- Newirradiation(Wh/m2):newirradiationvalue
  - Lastchangedtime:timeoflastchangeofadjustedvalue
- Lastchangedbyuser:userlastchangingthevalue
  - Lastchangedreason:reasonforlastchange
- Lastchangedcomment:commentonlastchange
...
Thispageisusedtoaddandchangebudgetforplants. User selects:

- Budget type
  - Plant
- Month

Existingbudgetnumbersperday,withmonthlyaggreagtedvalues,areshownintable. Toaddnewbudgetorupdateexisting,monthlynumbersarefilledinininputfields:
...
- Modifiedgridavailability(%)
  - Nettariff(LC/kWh)
- Usedatainapp:whethertoupdateappdatawiththesenumbers

Followingbuttonscanbepressedtodoactionsinpage(allactionsonselectedbudgettype,periodandplant):

- Storenewdata:storedataasentered
  - Updatefromactual:updatetheselectedperiodwithnumbersfrommeasurements
- Deletebudget:deletebudgetdata
  - Useinapp:updateappdatabasewiththisdata
- Copydata:copydatafromanexistingbudget
4. Weather data corrections

This page is used to administrate and recalculate weather station measurement data for a given timespan. Data can be recalculated based on meadured sensor data or based on SolarGIS data.

Usage:

- Selectfacilityandsetthetimespanforthedatatobecorrected
  - Click“GetFacilityData”toretrievedatainthe“Storedfacilitydatasection”.Inspectthedata.
- Selecttheparametersforrecalculationandpressbuttonfordesiredcalculationmethod.
  - Resultofoperationispresentedtouser

Note: Not all facilities have historical SolarGIS data. Then use forecast data The following measurements can be recalculated:
...
- Wind speed
- Environmental temperature
- Module temperature (not SolarGIS)
- Soiling Index (not SolarGIS)
- Update only missing data:
6  South Africa Sirius
1. Data collection and storage
1. Sirius Data collection overview

DatacollectedusingEthernet

- Modbus

Mostvaluesloggedwith1minuteinterval. Datatagsnameformat:COUNTRY-SITE-PLANTLOCATION-EQUIPMENT.SUBEQUIPMENT-DATAPOINT Alarmsaregeneratedwhencommunicationlost. Overviewofcollecteddatafromequipmentisfoundineachsubsection.

See Tag Listfordetailsoneachtag.

Onlinedataprocessingisdoneinspecialtagmodules.Someofthemostimportantmodulesare:

- WeatherCalc:calculatingonlineaveragevaluesfromweatherstationdata
  - MeterCalc:calculatingonlineaverageandsumvaluesfrommeters
- TrackerStatusandTR\_Calc:calculationonlineaverage,maxandminvaluesfromtrackers
  - InverterStatus:calculatingstatusandcountervaluesforinverters
- SM\_Calc:calculationonlineaverage,maxandminvaluesfromstringmonitors

See Sirius 1 calculationtagsforcompletetaglists.

2. Sirius Alarms overview

Alarmsignalsarecollectedfromequipment,andgeneratesalarmsintheSCADAserver:

- Inverter
  - Frominverterandtrafoalarmsignals
  - Trackers
    - Alarmsignalsfromtracker
    - Switches(onswitchnotinnormalposition)
      - Whenswitchisnotinnormalposition(normallyclosed)alarmisgeneratedforallMVandHV switches
    - Communicationstatus
      - Communicationlostforallequipment,instrumentsandmeters(communicationfromSCADAto unit)
    - Gridfrequencymeasurement
      - Whenfrequencymeasurementfromtransducerisoutsidealarmlimits,setunderSirius**System setup parameters ('Rengy System setup parameters' in the on-line documentation)**
    - Gridvoltagemeasurement
      - Whenvoltagemeasurementfromtransducerisoutsidealarmlimits,setunderSirius**System setup parameters ('Rengy System setup parameters' in the on-line documentation)**
    - PPC alarms
      - AlarmsaregeneratedbasedonstatusandalarmsignalsfromPPC
3. Sirius Databases overview

APISHoneystoretimeseriesdatabases:

- SA-S1-Log1Min:
  - 1minutesampleddatabase
  - 2 years horizon
    - 20yearshorizononcentral
  - SA-S1-Log10Min:
    - 10minutesampleddatabase
    - 20 years horizon
- SA-S1-Forecast:
  - PVSYSTforecastdata
  - 20 years horizon
  - SA-S1-Log1Sec:
    - 1secondsampleddatabase
      - 1 year horizon
    - OnlydatafromPPC,transducersandwindmeasurements
- SA-S1-Event:
  - Eventbaseddatabase,loggedwith1secperiod.States,alarms,etc.
  - 20 years horizon

PlantdatabaseinSQLserver:

- PDSdb\_SA\_S1
4. Sirius Naming concepts

See **overall naming concepts. (Section 4.2.2)** SA: South Africa

S1: Sirius 1

5. Sirius Substation data collection
- Energy meters:
  - Activeandreactiveenergyandpowervaluesforfeed-inandconsumption
    - Voltages,currentsandothermeasurements
  - Datapolledevery1sec.
    - Loggedin1secand1minutesampleddatabase
  - Switchandbreakerstatus
    - Open/closeonswitches
- Earthbreakerstatus(notshowninHMI)
  - Alarmsandtrips

Metersshownintablebelow:

Meter name Description SA-S1-SSS-MV MediumVoltagemeter

6. Sirius Inverter data collection
- DatacollectedfromeachinverterusingModbusTCP
  - Datapolledevery1sec.andloggedevery1minute
- NamingSA-S1-TS01toSA-XX-TS20forallstations
  - EachinverteraddsI01–I03forthe3invertersoneachtrafostation.E.g.SA-S1-TS01.I01,andSA-S1- TS02.I03
    - Measurements,Alarmsandtrips,Statusandmodesignals
      - Realtimecalculations
        - Mainstatus:
          - 0=comm loss (grey with yellow border)
            - 1=OK(green)
          - 2=Warning(yellow)
            - 3=Error(red)-FaultpresentorSwitchingondisabled
          - 4=Stop,notproducing(grey)
          - RelativePerformance
            - 0-100%productionofaverageogproducing
7. Sirius Weather data
- Dataiscollectedfrom7weatherstationinpark+oneatO&Mbuilding
  - AllstationsareinterfacedusingModbusTCPoverEthernet,anddatacollectedevery1sec.
- Datapointsonweatherstations: Ambienttemperature Module Temperature Rainfall
...
Inclineirradiation Globalirradiation Cleanreferencecell Dirtyreferencecell

Air Pressure

Snow depth

Nameonstationsintablebelow:

Sirius 1

SA-S1-CB-WS1 WeatherstationO&Mbuilding SA-S1-TS02-WS2 Weatherstationfield SA-S1-TS07-WS3 Weatherstationfield

SA-S1-TS09-WS4 Weatherstationfield SA-S1-TS10-WS5 Weatherstationfield SA-S1-TS12-WS6 Weatherstationfield SA-S1-TS18-WS7 Weatherstationfield SA-S1-TS20-WS8

8. Sirius PPC data collection
- PPCmeasurementsandstatus/alarmsarecollectedandlogged:
  - Setpointsforcontrolmodes–commandandrealsetpoint
  - Controlmodes–commandandrealsetpoint
    - Remoteorlocalcontrol
      - Alarmscalculatedwhenoneofthecontrolmodesareenabled
9. Sirius Forecast data import

StandardforecastdatafromPVSYSTandSolarGIS

10. Sirius String Monitoring
- DatacollectedfromeachcombinerboxthroughcommonMoxacomboxontrafostation
  - Stringcurrentandvoltagemeasurements
  - Eachinverterhas5combinerboxeswith10currentchannels
    - NamingSA-S1-TS01-I01-SMtoSA-S1-TS01-I03-SMforeachstation
  - CombinerboxesnamedSM1toSM5
    - Currentchannelmumbered01-10
  - Example:SA-S1-TS01-I01-SM.SM16.Current\_Channel\_07
  - Calculations
    - Power:voltage\*current
      - Averagecurrentforacombinerbox
    - Deviationbetweencurrentandaveragecurrent
      - Min,max,avgcurrentwithinacombinerbox
    - Alarmifdeviationisoutsidelimits
      - Showsalarmbellinoverviewscreen
    - Onlycalculatedbetween10aman2pm
      - 4% warning
    - 8% alarm
2. Plant state registration
1. Sirius plant state registration

Conceptsofstateregistrationarefoundunderthe**general section. (Section 4.3.1)** ForMalaysia,thefollowingstateregistrationsaresetup:

- **Inverter state ('Apodi Inverter state registration' in the on-line documentation)**
  - **Grid state ('Apodi Grid state registration' in the on-line documentation)**
2. Sirius Inverter state registration

Inverterstateisregisteredautomaticallybasedontheoperationstatemodetagfromtheinverter.Thecodecanbe correctedinthe**manual correction screen ('Malaysia Equipment downtime' in the on-line documentation)**.

Generalalgoritmandstatesasfound**here (Section 4.3.2)** is used. StatesforGEinverterisfoundin**GPTech inverter (Section 4.3.10.3)**.

3. Sirius Grid state registration

Gridstateisregisteredautomaticallybasedonswitchstatusonthegeneralprotectioncircuitbreaker.Thecodesare manuallycorrectedandcommentedinthe**manual registration screen ('Apodi Equipment downtime' in the on-line documentation)**.

Generalalgoritmandstatesasfound**here (Section 4.3.4)** is used.

3. Plant monitoring
1. Sirius Plant overview

See **Plant overview (Section 4.10.1)**andUsertrainingmanual

2. Sirius Overall production overview

See **Overall production overview and User training manual (Section 4.10.2)**

3. Sirius String monitors overview

See **String monitor overview (Section 4.10.3)**andUsertrainingmanual

4. Sirius String monitor details

See **String monitor overview (Section 4.10.3)**andUsertrainingmanual

5. Sirius Transformer switch overview

See **Transformer switch overview (Section 4.10.4)**andUsertrainingmanual

6. Sirius Inverter details

See **Inverter details (Section 4.10.5)**andUsertrainingmanual

7. Sirius Inverter power overview

See **Inverter power overview (Section 4.10.6)**andUsertrainingmanual

8. Sirius Inverter insulation overview

See **Inverter insulation overview (Section 4.10.7)**andUsertrainingmanual

9. Sirius Substation

See **Substation (Section 4.10.8)**andUsertrainingmanual

10. Sirius PPC details

See **PPC data (Section 4.10.11)**andUsertrainingmanual

11. Sirius Weather data

See **Weather data (Section 4.10.9)**andUsertrainingmanual

12. Sirius Alarm list

Standardalarmlist,see**Alarm list (Section 4.10.12)**andUsertrainingmanual

4. Plant reports
1. Sirius Forecast vs. yield report chart

See **Plant forecast reports (Section 4.7.6)**

2. Sirius Forecast vs. yield report table

See **Plant forecast reports (Section 4.7.6)**

3. Sirius Forecast table report

Thisreportpresent**PVSYST forecast data (Section 4.8.2)**foratimeperiodandinterval. Dataisaggregatedwithinthatintervalandpresentedintable.

- Energyforecast:sumofforecastedenergyproduction
  - Inclineirradiation:averageofforecastedinclineirradiation
- Horizontalirradiation:averageofforecastedhorizontalirradiation
  - Environmenttemperature:averageofforecastedenvironmenttemperature
4. Sirius Process Explorer

Thisisstandard**APIS Process Explorer (Section 4.7.3)**application. Dataisretrievedfromlocalplantdatabases,SA-S1-Log1Sec,SA-S1-Log1Min,SA-S1-LogEventandSA-S1-Log10Min.

SA-S1: Sirius

5. Sirius Alarm history

Thisisstandard**historical alarms & events (Section 4.7.2)** report.

6. Sirius Grid downtime summary

Thisisaplantreportshowingsummarydatafrom**grid state registration ('Malaysia Grid state registration' in the on-line documentation)**.

Reportisoperatedasdescribedin**down time reports (Section 4.7.5)**.

7. Sirius Grid downtime events

Thisisaplantreportshowingalleventsfrom**grid state registration ('Malaysia Grid state registration' in the on-line documentation)**.

Reportisoperatedasdescribedin**down time reports (Section 4.7.5)**.

8. Sirius Inverter downtime summary

Thisisaplantreportshowingsummarydatafrom**inverter state registration ('Malaysia Inverter state registration' in the on-line documentation)**.

Reportisoperatedasdescribedin**down time reports (Section 4.7.5)**.

9. Sirius Inverter downtime events

Thisisaplantreportshowingalleventsfrom**inverter state registration ('Malaysia Inverter state registration' in the on-line documentation)**.

Reportisoperatedasdescribedin**down time reports (Section 4.7.5)**.

5. Manual data input
1. Sirius Equipment downtime

Standardinputscreenfor**Equipment downtime (state) registration (Section 4.4.1)**

2. Sirius Planned power reduction

Standardinputscreenfor**Planned power reduction registration (Section 4.4.2)**

3. Sirius Planned outages

Standardinputscreenfor**Planned outages registration (Section 4.4.3)**

4. Sirius Daily plant report

See **Daily plant report (Section 4.4.4)**

6. System setup
1. Sirius Equipment parameters

See **Equipment parameters general (Section 4.5.2)**

2. Sirius Plant parameters

See **Plant parameters general (Section 4.5.3)**

3. Sirius Plant section parameters

See **Plant section parameters general (Section 4.5.4)**

4. Sirius Inverter parameters

See **Inverter parameters general (Section 4.5.5)**

5. Sirius System setup parameters

See **System setup parameters general (Section 4.5.6)**

6. Sirius Equipment stop codes

See **Equipment stop codes general (Section 4.5.7)**.

Stopcodesasdefinedfor**inverter ('Egypt Inverter state registration' in the on-line documentation)**, **tracker ('Egypt Tracker state registration' in the on-line documentation)** and **grid ('Egypt Grid state registration' in the on-line documentation)**stateregistration.

7. Sirius Meter parameters

See **Meter parameters general (Section 4.5.8)**

7. Forecast

6.7.1 Sirius Forecast

PVSYSTforecastisloadedasdescribedin**PVSYST forecast (Section 4.8.2)** SolarGISdataisrequestedperiodicallyasdescribedin**SolarGIS forecast (Section 4.8.3)** Budgetdataisuploadedasdescribedin**Scatec budget data (Section 4.8.4)**

8. Central reports
1. Calculations
1. Sirius Performance ratio

See **Performance ratio calculation (Section 4.7.7.4)**.

2. Sirius Plant availability

See **Plant availability calculation (Section 4.7.7.1)**

3. Sirius Grid availability

See **Grid availability calculation (Section 4.7.7.2)**

4. Sirius Failure rate and repair time

See **Failure rate and repair time calculation (Section 4.7.7.3)**

5. Sirius Deemed energy calculations

ThedeemedenergypaymentformulaisdefinedindetailinthePPAagreement.

2. Reports
1. Sirius Availability details

See **Availability details (Section 5.6.4.2)**

2. Sirius Daily management report

See **Daily management report (Section 5.6.4.5)**

3. Sirius Deemed energy

See **Deemed energy (Section 5.6.4.6)**

4. Sirius Energy report

See **Energy Report (Section 5.6.4.7)**

5. Sirius Facility data

See **Facility data (Section 5.6.4.10)**

6. Sirius Inverter data

See **Inverter data (Section 5.6.4.14)**

7. Sirius KPI dashboard

See **Plant dashboard (Section 5.6.4.25). (Section 5.6.4.25)**

8. Sirius Meter report

See **Meter report (Section 5.6.4.17)**

9. Sirius Measured vs forecast

See **Measured vs forecast (Section 5.6.4.18)**

10. Sirius Monthly KPI Report

See **Monthly KPI report (Section 5.6.4.20)**

11. Sirius Performance ratio details

See **Performance ratio details (Section 5.6.4.24)**

12. Sirius Weather report

See **Weather report (Section 5.6.4.33)**

3. Analysis
1. Sirius Facility Power Curve

See **FPC report (Section 5.6.4.11)**

2. Sirius External weather data

See **External weather data report (Section 5.6.5.1)**

3. Sirius Soiling report

See **Soiling report (Section 5.6.5.3)**

9. Sirius Web portal and access

ThewebportalontheplantserverisopenedwiththeURLaddress <http://SCADA1SAS1/SSO_SA_S1/Login3.aspx>

Startingtheportalandlogginginisasdescribedin**Web portal basics. (Section 4.1.1)** Themenuisbuiltupwithonemainfolderforeachplant.Underplantfolder,subfoldersarefoundfor:
...
Theuserrolesfoundontheplantserverare:

- Plantmonitoring:accesstomonitoringscreens(withoutalarmacknowledgement)andreports
  - Plantmonitoringandcontrol:accesstomonitoringscreens(withalarmacknowledgement),control functionsandreports
    - Plantsupervisor:accesstomonitoringscreens(withalarmacknowledgement),controlfunctions,manual datainputandreports
- Superuser:accesstomonitoringscreens,manualdata,reportsandsetupscreens
  - SystemAdministration:accesstomonitoringscreens,manualdata,reports,setupscreensand administrationscreens
    - Plantreporting:accesstoreports
      - SystemConfiguration:accesstoall,includingsystemconfigurationscreens
10. Sirius Other resources

Trainingmaterialisavailablefromlinksbelow:

- Userandtraningmanual,english
  - PDF user manual

Taglistsareavailablefromlinksbelow:
